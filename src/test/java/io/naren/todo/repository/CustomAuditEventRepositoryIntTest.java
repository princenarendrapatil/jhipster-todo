package io.naren.todo.repository;

import io.naren.todo.TodoApp;
import io.naren.todo.config.Constants;
import io.naren.todo.config.audit.AuditEventConverter;
import io.naren.todo.domain.PersistentAuditEvent;
...
import static io.naren.todo.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
